				...
				<Card>
					<Card.Body className="jobViewCard">
						...
						<Card.Text>
							...
							tightening all the bolts and screws he could find but no avail. We recently moved into this
							home and do not have any money to hire a professional plumber. We would buy all necessary
							parts.
						</Card.Text>
				...
				<Card>
					<Card.Body className="jobViewCard">
						...
						<Card.Text>
							...
							back. Due to my injuries I am not able to clean my home. I am supposed to be in bed-rest for
							approximately 3 weeks per doctors orders. The home has 2 beds and 2 baths, approximately
							1,200 square-feet.
						</Card.Text>
